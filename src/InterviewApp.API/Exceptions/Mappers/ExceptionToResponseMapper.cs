...
using InterviewApp.Core.Exceptions.Abstractions;

namespace InterviewApp.API.Exceptions.Mappers;

internal sealed class ExceptionToResponseMapper : IExceptionToResponseMapper
{
    private readonly ExceptionResponse _defaultResponse = new(new ErrorsResponse(
        new Error(
            "error",
            "There was an error."
        )),
    ...
    private readonly ExceptionResponse _communicationResponse = new(new ErrorsResponse(
        new Error(
    ...
    public ExceptionResponse Map(Exception exception)
        => exception switch
        {
            ExceptionBase ex => new ExceptionResponse(
